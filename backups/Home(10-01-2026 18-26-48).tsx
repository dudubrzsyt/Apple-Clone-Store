...
const sections: Section[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.apple.com/newsroom/images/product/imac-pro/Apple-Shop-with-a-Specialist-hero_big.jpg.large_2x.jpg", // Substituir por asset oficial Apple
    theme: "light",
  },
];
...
const SectionBlock: React.FC<{ section: Section; colors: ReturnType<typeof useTheme>["colors"] }> = ({ section, colors }) => {
  ...
  return (
    <main className="home">
      <section className="promo-educacao">
        <div className="promo-overlay">
          <div className="promo-texto">
            <h2>Compre um Mac ou iPad para a faculdade</h2>
            <p>com desconto para educação.</p>
            <p>E escolha: AirPods ou um acessório qualificado*</p>
