  ...
  return (
    ...
    >
      ...
      >
        ...
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRV-YlqtHpoXDc0YXz-G0wDA1vI-A7pONVAeg&s"
      ...
      >
        ...
        >
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSRr9gySbUWh4PJQzOVB4Ks_aLmrTd1b_0Qw&s"
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvpHmEG2sSFH4kjmpAPnkV-GI2zUWyYLECeQ&s"
              alt="Apple Music"
              style={{ width: "100%", height: 180, objectFit: "cover" }}
            />
            <div style={{ padding: 20 }}>
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4p-WNBe8Fg5wcE8-S1czMe53pOwsK5R2HvQ&s"
              alt="Apple Arcade"
              style={{ width: "100%", height: 180, objectFit: "cover" }}
            />
            <div style={{ padding: 20 }}>
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSx_kVkHGkNrZAOn9G5KkiHeaTExCx07eornQ&s"
              alt="Apple Fitness+"
              style={{ width: "100%", height: 180, objectFit: "cover" }}
            />
            <div style={{ padding: 20 }}>
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbBx0WHdjv763ZCS_IOPb-wzsbj3j1Vv7lAA&s"
              alt="Apple Podcasts"
              style={{ width: "100%", height: 180, objectFit: "cover" }}
            />
            <div style={{ padding: 20 }}>
          ...
          >
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReQ4X52MD3ZgUccJ4SAws7NDndtRR0_THvuw&s"
              alt="Apple Books"
              style={{ width: "100%", height: 180, objectFit: "cover" }}
            />
            <div style={{ padding: 20 }}>
      ...
      >
        ...
        >
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            ...
            >
              <img
                src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRpW789TIh505_uUdGGCf9PD4FAEFXWlBxgNQ&s_${i + 1}.jpg`}
                alt={`Destaque ${i + 1}`}
      ...
      >
        ...
        <img
          src="https://www.apple.com/br/apple-one/images/meta/og__diu4z5hyr8ia_overview.png"
