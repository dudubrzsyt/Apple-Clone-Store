...
const sections: Section[] = [
  {
    ...
    description: [
      "Design unibody de alumínio: estrutura resistente e leve, com ótimo desempenho no uso diário.",
      "Proteção Ceramic Shield frontal e traseira: mais resistência a quedas e arranhões com Ceramic Shield 2.",
      "Bateria de até 31 horas de vídeo: mais autonomia com recarga rápida de 50% em apenas 20 minutos.",
      "Chip A19 Pro com resfriamento por evaporação: desempenho contínuo até 40% mais eficiente. ",
      "Sistema de câmera tripla com sensor principal de 48MP: fotos e vídeos incríveis em qualquer condição de luz.",
    ],
    price: "A partir de R$ 8.899",
    ctas: [
      { label: "Comprar", href: "#comprar-iphone17pro", variant: "primary" },
      { label: "Saiba mais", href: "#saiba-iphone17pro", variant: "ghost" },
    ],
  ...
  },
  {
    ...
    description: [
      "Com chips M3, M3, Pro, M3 Max,  M4,, Pro, M4, Max, M5, Pro, E, M5, MAX.",
      "Velocidade absurda.",
    ...
    imageUrl:
      "https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/mbp-og-202510?wid=1200&hei=630&fmt=jpeg&qlt=90&.v=1758663225828", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "imac",
    ...
    imageUrl:
      "https://m.media-amazon.com/images/I/51lkhZPoXML._AC_SX522_.jpg", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "watch9",
    ...
    imageUrl:
      "https://http2.mlstatic.com/D_NQ_NP_2X_871257-MLA96891617894_112025-F.webp", // Substituir por asset oficial Apple
    theme: "dark",
  },
  {
    id: "watchultra2",
    ...
    imageUrl:
      "https://images0.kabum.com.br/produtos/fotos/634540/apple-watch-ultra-2-gps-cellular-case-natural-de-titanio-de-49-mm-pulseira-natural-estilo-milanes-de-titanio-m-mx5r3be-a_1726510247_gg.jpg", // Substituir por asset oficial Apple
    theme: "dark",
  },
  {
    id: "airpods",
    ...
    imageUrl:
      "https://http2.mlstatic.com/D_NQ_NP_2X_841774-MLA96136658915_102025-F.webp", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "appstore",
    ...
    imageUrl:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/App_Store_%28iOS%29.svg/1280px-App_Store_%28iOS%29.svg.png", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "tvplus",
    ...
    imageUrl:
      "https://www.apple.com/newsroom/images/product/tv/standard/Apple-TV-4K-hero-221018_big.jpg.large_2x.jpg", // Substituir por asset oficial Apple
    theme: "dark",
  },
  {
    id: "music",
    ...
    imageUrl:
      "https://external-preview.redd.it/ios-17-apple-music-ui-refresh-v0-HaoyzbgVHusMDRnrwHcXbw3nOZQzt4dzqrIB6ACadXE.jpg?auto=webp&s=fbc336aca10b3504562cf1ff373a13e320a5100c", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "icloud",
    ...
    imageUrl:
      "https://www.apple.com/v/icloud/ai/images/overview/hero_icloud__e5pazz6xmweq_large_2x.png", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "support",
    ...
    imageUrl:
      "https://support.apple.com/content/dam/edam/applecare/images/en_US/psp/psp_heroes/support-home-apple-logo-circle-blue.png", // Substituir por asset oficial Apple
    theme: "light",
  },
  {
    id: "store",
    ...
    imageUrl:
      "https://www.apple.com/newsroom/images/2023/10/apple-store-online-launches-in-chile/article/Apple-Store-online-Chile-homepage_big.jpg.large_2x.jpg", // Substituir por asset oficial Apple
    theme: "light",
  },
];
