  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* COLOQUE AQUI UMA IMAGEM DO ECOSSISTEMA APPLE (MAC + IPHONE + IPAD + WATCH) */}
        <img
          src="COLOQUE_AQUI_IMAGEM_ECOSSISTEMA_APPLE.jpg"
      ...
      >
        {/* COLOQUE AQUI UMA IMAGEM DE CLOSE DO MACBOOK PRO (TECLADO/ TELA/ LATERAL) */}
        <img
          src="COLOQUE_AQUI_IMAGEM_CLOSE_MACBOOK_PRO.jpg"
